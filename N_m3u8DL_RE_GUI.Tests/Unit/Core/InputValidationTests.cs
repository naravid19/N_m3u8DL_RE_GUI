...
public class InputValidationTests
{
    ...
    [InlineData("HTTP://example.com/a.m3u8", true)]
    [InlineData("https://192.168.1.1:8080/stream.m3u8?token=xyz", true)]
    [InlineData("http://localhost:3000/video.mpd", true)]
    ...
    [InlineData("file:///C:/videos/video.m3u8")]
    [InlineData("https://?query-only")]
    public void IsHttpUrl_RejectsInvalidAbsoluteUrls(string value)
    {
