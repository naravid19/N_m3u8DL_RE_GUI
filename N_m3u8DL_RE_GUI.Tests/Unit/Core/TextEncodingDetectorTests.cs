...
public class TextEncodingDetectorTests
{
    ...
    public void DetectFromStream_WithIncompleteUtf8Sequence_ShouldReturnDefaultEncoding()
    {
        ...
        Assert.Equal(TextEncodingDetector.AnsiFallback.WebName, encoding.WebName);
    }
    ...
    {
        using var stream = new MemoryStream(new byte[] { 0x41, 0x42, 0x43, 0x44 });
        stream.Position = 2;
    ...
    [Fact]
    public void DetectFromStream_WithVeryLargeLength_ShouldReturnUtf8ForAscii()
    {
